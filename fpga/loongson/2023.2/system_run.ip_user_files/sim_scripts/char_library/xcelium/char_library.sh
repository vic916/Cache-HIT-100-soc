...
#
# Script generated by Vivado on Tue Aug 19 23:31:38 +0800 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : char_library.sh
...
#
# Usage        : char_library.sh
#                char_library.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                char_library.sh [-reset_run]
#                char_library.sh [-reset_log]
#                char_library.sh [-help]
#
...
#                script (type 'char_library.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname blk_mem_gen_v8_4_7 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm blk_mem_gen_v8_4_7 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "char_library.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./char_library.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.char_library xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.char_library -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log char_library_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./char_library.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: char_library.sh [-help]\n\
Usage: char_library.sh [-step]\n\
Usage: char_library.sh [-lib_map_path]\n\
Usage: char_library.sh [-reset_run]\n\
Usage: char_library.sh [-reset_log]\n\
Usage: char_library.sh [-keep_index]\n\
Usage: char_library.sh [-noclean_files]\n\n\
