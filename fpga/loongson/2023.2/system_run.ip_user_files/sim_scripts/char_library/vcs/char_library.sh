...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.char_library xil_defaultlib.glbl -o char_library_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./char_library_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key char_library_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc char_library_simv.daidir vcs_lib c.obj)
