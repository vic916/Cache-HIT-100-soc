...
design_libs=(xpm generic_baseblocks_v2_1_1 fifo_generator_v13_2_9 axi_data_fifo_v2_1_28 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_29 axi_protocol_converter_v2_1_29 xil_defaultlib)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ipstatic/hdl" \
  ...
  vlogan -work generic_baseblocks_v2_1_1 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" \
  "../../../ipstatic/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work fifo_generator_v13_2_9 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" \
  ...
  vlogan -work axi_data_fifo_v2_1_28 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" \
  "../../../ipstatic/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" \
  "../../../ipstatic/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_register_slice_v2_1_29 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" \
  "../../../ipstatic/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_protocol_converter_v2_1_29 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" \
  "../../../ipstatic/hdl/axi_protocol_converter_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axi_protocol_converter_0 xil_defaultlib.glbl -o axi_protocol_converter_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axi_protocol_converter_0_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/XF/Desktop/chiplabdemo/chiplab/fpga/loongson/2023.2/system_run.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key axi_protocol_converter_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi_protocol_converter_0_simv.daidir vcs_lib c.obj)
