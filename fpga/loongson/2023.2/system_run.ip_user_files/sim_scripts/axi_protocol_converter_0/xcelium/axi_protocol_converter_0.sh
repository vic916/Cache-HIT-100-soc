...
#
# Script generated by Vivado on Tue Aug 19 23:15:24 +0800 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axi_protocol_converter_0.sh
...
#
# Usage        : axi_protocol_converter_0.sh
#                axi_protocol_converter_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_protocol_converter_0.sh [-reset_run]
#                axi_protocol_converter_0.sh [-reset_log]
#                axi_protocol_converter_0.sh [-help]
#
...
#                script (type 'axi_protocol_converter_0.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname generic_baseblocks_v2_1_1 -libname fifo_generator_v13_2_9 -libname axi_data_fifo_v2_1_28 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_29 -libname axi_protocol_converter_v2_1_29 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm generic_baseblocks_v2_1_1 fifo_generator_v13_2_9 axi_data_fifo_v2_1_28 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_29 axi_protocol_converter_v2_1_29 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axi_protocol_converter_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_protocol_converter_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl" \
  ...
  xmvlog -work generic_baseblocks_v2_1_1 $xmvlog_opts +incdir+"../../../ipstatic/hdl" \
  "../../../ipstatic/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work fifo_generator_v13_2_9 $xmvlog_opts +incdir+"../../../ipstatic/hdl" \
  ...
  xmvlog -work axi_data_fifo_v2_1_28 $xmvlog_opts +incdir+"../../../ipstatic/hdl" \
  "../../../ipstatic/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../ipstatic/hdl" \
  "../../../ipstatic/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_29 $xmvlog_opts +incdir+"../../../ipstatic/hdl" \
  "../../../ipstatic/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_protocol_converter_v2_1_29 $xmvlog_opts +incdir+"../../../ipstatic/hdl" \
  "../../../ipstatic/hdl/axi_protocol_converter_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../ipstatic/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi_protocol_converter_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi_protocol_converter_0 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/XF/Desktop/chiplabdemo/chiplab/fpga/loongson/2023.2/system_run.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi_protocol_converter_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi_protocol_converter_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi_protocol_converter_0.sh [-help]\n\
Usage: axi_protocol_converter_0.sh [-step]\n\
Usage: axi_protocol_converter_0.sh [-lib_map_path]\n\
Usage: axi_protocol_converter_0.sh [-reset_run]\n\
Usage: axi_protocol_converter_0.sh [-reset_log]\n\
Usage: axi_protocol_converter_0.sh [-keep_index]\n\
Usage: axi_protocol_converter_0.sh [-noclean_files]\n\n\
