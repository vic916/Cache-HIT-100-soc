...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L generic_baseblocks_v2_1_1 -L fifo_generator_v13_2_9 -L axi_data_fifo_v2_1_28 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_29 -L axi_protocol_converter_v2_1_29 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_protocol_converter_0 xil_defaultlib.axi_protocol_converter_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_protocol_converter_0 -key {Behavioral:sim_1:Functional:axi_protocol_converter_0} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Xilinx/Vivado/2023.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_protocol_converter_0.wdb xsim.dir libdpi.so)
