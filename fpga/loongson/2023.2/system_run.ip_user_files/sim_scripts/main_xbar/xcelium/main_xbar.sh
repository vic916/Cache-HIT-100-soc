...
#
# Script generated by Vivado on Tue Aug 19 23:11:59 +0800 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : main_xbar.sh
...
#
# Usage        : main_xbar.sh
#                main_xbar.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                main_xbar.sh [-reset_run]
#                main_xbar.sh [-reset_log]
#                main_xbar.sh [-help]
#
...
#                script (type 'main_xbar.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname generic_baseblocks_v2_1_1 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_29 -libname fifo_generator_v13_2_9 -libname axi_data_fifo_v2_1_28 -libname axi_crossbar_v2_1_30 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm generic_baseblocks_v2_1_1 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_29 fifo_generator_v13_2_9 axi_data_fifo_v2_1_28 axi_crossbar_v2_1_30 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "main_xbar.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./main_xbar.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work axi_crossbar_v2_1_30 $xmvlog_opts +incdir+"../../../ipstatic/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.main_xbar xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.main_xbar -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log main_xbar_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./main_xbar.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: main_xbar.sh [-help]\n\
Usage: main_xbar.sh [-step]\n\
Usage: main_xbar.sh [-lib_map_path]\n\
Usage: main_xbar.sh [-reset_run]\n\
Usage: main_xbar.sh [-reset_log]\n\
Usage: main_xbar.sh [-keep_index]\n\
Usage: main_xbar.sh [-noclean_files]\n\n\
