...
design_libs=(xpm generic_baseblocks_v2_1_1 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_29 fifo_generator_v13_2_9 axi_data_fifo_v2_1_28 axi_crossbar_v2_1_30 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work axi_crossbar_v2_1_30 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.main_xbar xil_defaultlib.glbl -o main_xbar_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./main_xbar_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key main_xbar_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc main_xbar_simv.daidir vcs_lib c.obj)
