...
#
# Script generated by Vivado on Tue Aug 19 23:30:50 +0800 2025
...
#
# Usage        : ps2.sh
#                ps2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ps2.sh [-reset_run]
#                ps2.sh [-reset_log]
#                ps2.sh [-help]
#
...
#                script (type 'ps2.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname fifo_generator_v13_2_9 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm fifo_generator_v13_2_9 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "ps2.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ps2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work fifo_generator_v13_2_9 $xmvlog_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ps2 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ps2 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ps2_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ps2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ps2.sh [-help]\n\
Usage: ps2.sh [-step]\n\
Usage: ps2.sh [-lib_map_path]\n\
Usage: ps2.sh [-reset_run]\n\
Usage: ps2.sh [-reset_log]\n\
Usage: ps2.sh [-keep_index]\n\
Usage: ps2.sh [-noclean_files]\n\n\
