...
design_libs=(xpm fifo_generator_v13_2_9 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work fifo_generator_v13_2_9 $vlogan_opts +v2k \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ps2 xil_defaultlib.glbl -o ps2_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ps2_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ps2_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ps2_simv.daidir vcs_lib c.obj)
