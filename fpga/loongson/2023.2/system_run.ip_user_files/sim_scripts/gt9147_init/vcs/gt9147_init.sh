...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.gt9147_init xil_defaultlib.glbl -o gt9147_init_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./gt9147_init_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key gt9147_init_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc gt9147_init_simv.daidir vcs_lib c.obj)
