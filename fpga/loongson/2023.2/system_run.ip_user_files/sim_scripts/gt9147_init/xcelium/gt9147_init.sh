...
#
# Script generated by Vivado on Tue Aug 19 23:31:45 +0800 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : gt9147_init.sh
...
#
# Usage        : gt9147_init.sh
#                gt9147_init.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                gt9147_init.sh [-reset_run]
#                gt9147_init.sh [-reset_log]
#                gt9147_init.sh [-help]
#
...
#                script (type 'gt9147_init.sh -help' for more information).
#
...
# script info
echo -e "gt9147_init.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./gt9147_init.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.gt9147_init xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.gt9147_init -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log gt9147_init_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./gt9147_init.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: gt9147_init.sh [-help]\n\
Usage: gt9147_init.sh [-step]\n\
Usage: gt9147_init.sh [-lib_map_path]\n\
Usage: gt9147_init.sh [-reset_run]\n\
Usage: gt9147_init.sh [-reset_log]\n\
Usage: gt9147_init.sh [-keep_index]\n\
Usage: gt9147_init.sh [-noclean_files]\n\n\
