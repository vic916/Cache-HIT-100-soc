...
design_libs=(xpm lib_pkg_v1_0_3 axi_apb_bridge_v3_0_19 xil_defaultlib)
...
compile()
{
  ...
  vhdlan -work axi_apb_bridge_v3_0_19 $vhdlan_opts \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axi_apb_bridge_connect xil_defaultlib.glbl -o axi_apb_bridge_connect_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axi_apb_bridge_connect_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key axi_apb_bridge_connect_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi_apb_bridge_connect_simv.daidir vcs_lib c.obj)
