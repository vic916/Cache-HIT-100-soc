...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L lib_pkg_v1_0_3 -L axi_apb_bridge_v3_0_19 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_apb_bridge_connect xil_defaultlib.axi_apb_bridge_connect xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_apb_bridge_connect -key {Behavioral:sim_1:Functional:axi_apb_bridge_connect} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_apb_bridge_connect.wdb xsim.dir libdpi.so)
