...
#
# Script generated by Vivado on Tue Aug 19 23:20:48 +0800 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axi_apb_bridge_connect.sh
...
#
# Usage        : axi_apb_bridge_connect.sh
#                axi_apb_bridge_connect.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_apb_bridge_connect.sh [-reset_run]
#                axi_apb_bridge_connect.sh [-reset_log]
#                axi_apb_bridge_connect.sh [-help]
#
...
#                script (type 'axi_apb_bridge_connect.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname lib_pkg_v1_0_3 -libname axi_apb_bridge_v3_0_19 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm lib_pkg_v1_0_3 axi_apb_bridge_v3_0_19 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axi_apb_bridge_connect.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_apb_bridge_connect.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvhdl -work axi_apb_bridge_v3_0_19 $xmvhdl_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi_apb_bridge_connect xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi_apb_bridge_connect -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi_apb_bridge_connect_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi_apb_bridge_connect.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi_apb_bridge_connect.sh [-help]\n\
Usage: axi_apb_bridge_connect.sh [-step]\n\
Usage: axi_apb_bridge_connect.sh [-lib_map_path]\n\
Usage: axi_apb_bridge_connect.sh [-reset_run]\n\
Usage: axi_apb_bridge_connect.sh [-reset_log]\n\
Usage: axi_apb_bridge_connect.sh [-keep_index]\n\
Usage: axi_apb_bridge_connect.sh [-noclean_files]\n\n\
