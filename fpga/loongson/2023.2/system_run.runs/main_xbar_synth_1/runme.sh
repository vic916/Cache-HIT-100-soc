...
HD_PWD='C:/Users/XF/Desktop/chiplabdemo/chiplab/fpga/loongson/2023.2/system_run.runs/main_xbar_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_xbar.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_xbar.tcl
