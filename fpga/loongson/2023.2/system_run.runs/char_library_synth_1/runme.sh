...
HD_PWD='C:/Users/XF/Desktop/chiplabdemo/chiplab/fpga/loongson/2023.2/system_run.runs/char_library_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log char_library.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source char_library.tcl
