...
HD_PWD='C:/Users/XF/Desktop/chiplabdemo/chiplab/fpga/loongson/2023.2/system_run.runs/refresh1_bram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log refresh1_bram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source refresh1_bram.tcl
