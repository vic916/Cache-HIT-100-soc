...
module v_frmbuf_wr_0_Bytes2AXIMMvideo_Pipeline_VITIS_LOOP_1285_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln1285_fu_112_p2;
...
reg   [127:0] bytePlanes_read_reg_151;
reg    ap_block_pp0_stage0_01001;
reg   [11:0] x_fu_70;
wire   [11:0] add_ln1285_fu_118_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln1285_fu_112_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1285_fu_112_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign add_ln1285_fu_118_p2 = (ap_sig_allocacmp_x_3 + 12'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = (((m_axi_mm_video_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_block_state2_pp0_stage0_iter1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((m_axi_mm_video_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_block_state2_pp0_stage0_iter1)));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (bytePlanes_empty_n == 1'b0);
end
...
assign icmp_ln1285_fu_112_p2 = ((ap_sig_allocacmp_x_3 == loopWidth) ? 1'b1 : 1'b0);
...
assign m_axi_mm_video_WDATA = bytePlanes_read_reg_151;
...
endmodule //v_frmbuf_wr_0_Bytes2AXIMMvideo_Pipeline_VITIS_LOOP_1285_1
