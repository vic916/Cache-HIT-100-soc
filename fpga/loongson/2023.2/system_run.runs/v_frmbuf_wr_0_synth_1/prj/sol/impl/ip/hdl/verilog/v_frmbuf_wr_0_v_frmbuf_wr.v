...
reg   [31:0] frm_buffer_read_reg_217;
reg   [15:0] stride_read_reg_222;
wire   [5:0] empty_fu_187_p1;
reg   [5:0] empty_reg_227;
wire   [11:0] empty_50_fu_191_p1;
reg   [11:0] empty_50_reg_232;
wire   [11:0] empty_51_fu_195_p1;
reg   [11:0] empty_51_reg_237;
wire  signed [14:0] empty_52_fu_199_p1;
reg  signed [14:0] empty_52_reg_242;
reg   [2:0] BYTES_PER_PIXEL_load_reg_257;
wire    ap_CS_fsm_state2;
reg   [2:0] colorFormat_reg_262;
wire   [14:0] WidthInBytes_fu_212_p2;
reg   [14:0] WidthInBytes_reg_267;
wire    ap_CS_fsm_state3;
wire    grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_AWVALID;
wire   [31:0] grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_AWADDR;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_AWID;
wire   [31:0] grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_AWLEN;
wire   [2:0] grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_AWSIZE;
wire   [1:0] grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_AWBURST;
wire   [1:0] grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_AWLOCK;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_AWCACHE;
wire   [2:0] grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_AWPROT;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_AWQOS;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_AWREGION;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_AWUSER;
wire    grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_WVALID;
wire   [127:0] grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_WDATA;
wire   [15:0] grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_WSTRB;
wire    grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_WLAST;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_WID;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_WUSER;
wire    grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_ARVALID;
wire   [31:0] grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_ARADDR;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_ARID;
wire   [31:0] grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_ARLEN;
wire   [2:0] grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_ARSIZE;
wire   [1:0] grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_ARBURST;
wire   [1:0] grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_ARLOCK;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_ARCACHE;
wire   [2:0] grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_ARPROT;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_ARQOS;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_ARREGION;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_ARUSER;
wire    grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_RREADY;
wire    grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_BREADY;
wire    grp_FrmbufWrHlsDataFlow_fu_160_ap_start;
wire    grp_FrmbufWrHlsDataFlow_fu_160_s_axis_video_TREADY;
wire    grp_FrmbufWrHlsDataFlow_fu_160_ap_done;
wire    grp_FrmbufWrHlsDataFlow_fu_160_ap_ready;
wire    grp_FrmbufWrHlsDataFlow_fu_160_ap_idle;
reg    grp_FrmbufWrHlsDataFlow_fu_160_ap_continue;
wire    flush;
...
reg    mm_video_BREADY;
reg    grp_FrmbufWrHlsDataFlow_fu_160_ap_start_reg;
wire    ap_CS_fsm_state4;
wire    ap_CS_fsm_state5;
wire    ap_sync_grp_FrmbufWrHlsDataFlow_fu_160_ap_ready;
wire    ap_sync_grp_FrmbufWrHlsDataFlow_fu_160_ap_done;
reg    ap_block_state5_on_subcall_done;
reg    ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_160_ap_ready;
reg    ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_160_ap_done;
wire   [31:0] zext_ln194_fu_203_p1;
wire   [2:0] WidthInBytes_fu_212_p1;
reg   [4:0] ap_NS_fsm;
...
wire   [14:0] WidthInBytes_fu_212_p10;
wire    ap_ce_reg;

// power-on initialization
initial begin
#0 ap_CS_fsm = 5'd1;
#0 grp_FrmbufWrHlsDataFlow_fu_160_ap_start_reg = 1'b0;
#0 ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_160_ap_ready = 1'b0;
#0 ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_160_ap_done = 1'b0;
end

v_frmbuf_wr_0_BYTES_PER_PIXEL_ROM_AUTO_1R #(
    .DataWidth( 3 ),
    .AddressRange( 44 ),
    .AddressWidth( 6 ))
BYTES_PER_PIXEL_U(
...
v_frmbuf_wr_0_MEMORY2LIVE_ROM_AUTO_1R #(
    .DataWidth( 3 ),
    .AddressRange( 44 ),
    .AddressWidth( 6 ))
MEMORY2LIVE_U(
...
v_frmbuf_wr_0_FrmbufWrHlsDataFlow grp_FrmbufWrHlsDataFlow_fu_160(
...
v_frmbuf_wr_0_mul_15s_3ns_15_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 15 ),
    .din1_WIDTH( 3 ),
    .dout_WIDTH( 15 ))
mul_15s_3ns_15_1_1_U125(
    .din0(empty_52_reg_242),
    .din1(WidthInBytes_fu_212_p1),
    .dout(WidthInBytes_fu_212_p2)
);

v_frmbuf_wr_0_regslice_both #(
    .DataWidth( 48 ))
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_160_ap_done <= 1'b0;
    end else begin
        if (((1'b0 == ap_block_state5_on_subcall_done) & (1'b1 == ap_CS_fsm_state5))) begin
            ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_160_ap_done <= 1'b0;
        end else if ((grp_FrmbufWrHlsDataFlow_fu_160_ap_done == 1'b1)) begin
            ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_160_ap_done <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_160_ap_ready <= 1'b0;
    end else begin
        if (((1'b0 == ap_block_state5_on_subcall_done) & (1'b1 == ap_CS_fsm_state5))) begin
            ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_160_ap_ready <= 1'b0;
        end else if ((grp_FrmbufWrHlsDataFlow_fu_160_ap_ready == 1'b1)) begin
            ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_160_ap_ready <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_FrmbufWrHlsDataFlow_fu_160_ap_start_reg <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_state4) | ((ap_sync_grp_FrmbufWrHlsDataFlow_fu_160_ap_ready == 1'b0) & (1'b1 == ap_CS_fsm_state5)))) begin
            grp_FrmbufWrHlsDataFlow_fu_160_ap_start_reg <= 1'b1;
        end else if ((grp_FrmbufWrHlsDataFlow_fu_160_ap_ready == 1'b1)) begin
            grp_FrmbufWrHlsDataFlow_fu_160_ap_start_reg <= 1'b0;
        end
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_state5_on_subcall_done) & (1'b1 == ap_CS_fsm_state5))) begin
        grp_FrmbufWrHlsDataFlow_fu_160_ap_continue = 1'b1;
    end else begin
        grp_FrmbufWrHlsDataFlow_fu_160_ap_continue = 1'b0;
    end
end
...
assign BYTES_PER_PIXEL_address0 = zext_ln194_fu_203_p1;

assign MEMORY2LIVE_address0 = zext_ln194_fu_203_p1;

assign WidthInBytes_fu_212_p1 = WidthInBytes_fu_212_p10;

assign WidthInBytes_fu_212_p10 = BYTES_PER_PIXEL_load_reg_257;
...
always @ (*) begin
    ap_block_state5_on_subcall_done = ((ap_sync_grp_FrmbufWrHlsDataFlow_fu_160_ap_ready & ap_sync_grp_FrmbufWrHlsDataFlow_fu_160_ap_done) == 1'b0);
end
...
assign ap_sync_grp_FrmbufWrHlsDataFlow_fu_160_ap_done = (grp_FrmbufWrHlsDataFlow_fu_160_ap_done | ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_160_ap_done);

assign ap_sync_grp_FrmbufWrHlsDataFlow_fu_160_ap_ready = (grp_FrmbufWrHlsDataFlow_fu_160_ap_ready | ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_160_ap_ready);

assign empty_50_fu_191_p1 = height[11:0];

assign empty_51_fu_195_p1 = width[11:0];

assign empty_52_fu_199_p1 = width[14:0];

assign empty_fu_187_p1 = video_format[5:0];

assign grp_FrmbufWrHlsDataFlow_fu_160_ap_start = grp_FrmbufWrHlsDataFlow_fu_160_ap_start_reg;

assign s_axis_video_TREADY = regslice_both_s_axis_video_V_data_V_U_ack_in;

assign zext_ln194_fu_203_p1 = video_format;


reg find_df_deadlock = 0;
// synthesis translate_off
`include "v_frmbuf_wr_0_hls_deadlock_detector.vh"
// synthesis translate_on

reg find_kernel_block = 0;
// synthesis translate_off
`include "v_frmbuf_wr_0_hls_deadlock_kernel_monitor_top.vh"
// synthesis translate_on

endmodule //v_frmbuf_wr_0_v_frmbuf_wr
