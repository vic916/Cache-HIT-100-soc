...
module v_frmbuf_wr_0_hls_deadlock_idx1_monitor ( // for module v_frmbuf_wr_0_v_frmbuf_wr_inst.grp_FrmbufWrHlsDataFlow_fu_160
    input wire clock,
    input wire reset,
...
assign process_axis_block_vec[1] = idx2_block & (1'b0 | axis_block_sigs[0] | axis_block_sigs[2] | axis_block_sigs[1]);
...
// instant sub module
 v_frmbuf_wr_0_hls_deadlock_idx2_monitor v_frmbuf_wr_0_hls_deadlock_idx2_monitor_U (
    .clock(clock),
    .reset(reset),
