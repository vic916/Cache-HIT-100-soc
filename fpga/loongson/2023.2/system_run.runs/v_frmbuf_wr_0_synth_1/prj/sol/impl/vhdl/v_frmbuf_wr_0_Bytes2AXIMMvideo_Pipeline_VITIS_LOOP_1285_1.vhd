...
entity v_frmbuf_wr_0_Bytes2AXIMMvideo_Pipeline_VITIS_LOOP_1285_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of v_frmbuf_wr_0_Bytes2AXIMMvideo_Pipeline_VITIS_LOOP_1285_1 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln1285_fu_112_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal bytePlanes_read_reg_151 : STD_LOGIC_VECTOR (127 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal x_fu_70 : STD_LOGIC_VECTOR (11 downto 0) := "000000000000";
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln1285_fu_112_p2 = ap_const_lv1_0))) then 
                    x_fu_70 <= add_ln1285_fu_118_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    x_fu_70 <= ap_const_lv12_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                ...
                bytePlanes_read_reg_151 <= bytePlanes_dout;
            end if;
        end if;
    end process;
    ...
    add_ln1285_fu_118_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_x_3) + unsigned(ap_const_lv12_1));
    ...
    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, ap_block_state2_pp0_stage0_iter1, m_axi_mm_video_WREADY)
    begin
                ap_block_pp0_stage0_11001 <= (((m_axi_mm_video_WREADY = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_boolean_1 = ap_block_state2_pp0_stage0_iter1)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, ap_block_state2_pp0_stage0_iter1, m_axi_mm_video_WREADY)
    begin
                ap_block_pp0_stage0_subdone <= (((m_axi_mm_video_WREADY = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_boolean_1 = ap_block_state2_pp0_stage0_iter1)));
    end process;


    ap_block_state2_pp0_stage0_iter1_assign_proc : process(bytePlanes_empty_n)
    begin
                ap_block_state2_pp0_stage0_iter1 <= (bytePlanes_empty_n = ap_const_logic_0);
    end process;


    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln1285_fu_112_p2)
    begin
        if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln1285_fu_112_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
    ...
    ap_sig_allocacmp_x_3_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, x_fu_70, ap_loop_init)
    begin
    ...
    bytePlanes_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, bytePlanes_empty_n, ap_block_pp0_stage0)
    begin
    ...
    bytePlanes_read_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
    ...
    icmp_ln1285_fu_112_p2 <= "1" when (ap_sig_allocacmp_x_3 = loopWidth) else "0";
    ...
    m_axi_mm_video_WDATA <= bytePlanes_read_reg_151;
    m_axi_mm_video_WID <= ap_const_lv1_0;
    m_axi_mm_video_WLAST <= ap_const_logic_0;
    m_axi_mm_video_WSTRB <= ap_const_lv16_FFFF;
