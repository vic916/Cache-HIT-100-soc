...
entity v_frmbuf_wr_0_start_for_Bytes2AXIMMvideo_U0 is 
    generic (
...
architecture rtl of v_frmbuf_wr_0_start_for_Bytes2AXIMMvideo_U0 is

    component v_frmbuf_wr_0_start_for_Bytes2AXIMMvideo_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
...
begin
----------------------- Instantiation -----------------------
    U_v_frmbuf_wr_0_start_for_Bytes2AXIMMvideo_U0_ShiftReg : v_frmbuf_wr_0_start_for_Bytes2AXIMMvideo_U0_ShiftReg
    generic map (
...
entity v_frmbuf_wr_0_start_for_Bytes2AXIMMvideo_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end v_frmbuf_wr_0_start_for_Bytes2AXIMMvideo_U0_ShiftReg;

architecture rtl of v_frmbuf_wr_0_start_for_Bytes2AXIMMvideo_U0_ShiftReg is
