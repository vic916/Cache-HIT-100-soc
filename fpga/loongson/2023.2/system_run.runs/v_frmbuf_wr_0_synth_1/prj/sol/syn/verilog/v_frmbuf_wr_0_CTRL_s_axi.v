...
// ==============================================================
`timescale 1ns/1ps
module v_frmbuf_wr_0_CTRL_s_axi
#(parameter
...
localparam
    ...
    ADDR_FRM_BUFFER3_DATA_0  = 7'h54,
    ADDR_FRM_BUFFER3_CTRL    = 7'h58,
    WRIDLE                   = 2'd0,
    WRDATA                   = 2'd1,
    WRRESP                   = 2'd2,
    WRRESET                  = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_FRM_BUFFER3_DATA_0: begin
                    rdata <= int_frm_buffer3[31:0];
                end
            endcase
        end
    end
...
assign frm_buffer3       = int_frm_buffer3;
// int_interrupt
always @(posedge ACLK) begin
    if (ARESET)
        int_interrupt <= 1'b0;
...
// int_frm_buffer3[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_frm_buffer3[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_FRM_BUFFER3_DATA_0)
            int_frm_buffer3[31:0] <= (WDATA[31:0] & wmask) | (int_frm_buffer3[31:0] & ~wmask);
    end
end
