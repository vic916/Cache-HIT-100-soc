...
set name v_frmbuf_wr_0_mul_15s_3ns_15_1_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler v_frmbuf_wr_0_BYTES_PER_PIXEL_ROM_AUTO_1R BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler v_frmbuf_wr_0_MEMORY2LIVE_ROM_AUTO_1R BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler v_frmbuf_wr_0_mm_video_m_axi BINDTYPE {interface} TYPE {adapter} IMPL {m_axi}
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler v_frmbuf_wr_0_CTRL_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
# RegSlice definition:
set ID 138
set RegSliceName v_frmbuf_wr_0_regslice_both
set RegSliceInstName v_frmbuf_wr_0_regslice_both_U
set CoreName ap_simcore_v_frmbuf_wr_0_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
