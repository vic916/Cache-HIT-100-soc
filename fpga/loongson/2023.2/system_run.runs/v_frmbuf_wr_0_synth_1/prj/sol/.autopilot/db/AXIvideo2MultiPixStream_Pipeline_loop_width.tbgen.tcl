...
set C_modelArgList {
	...
	{ axi_data_2 int 48 regular  }
	{ trunc_ln int 11 regular  }
	{ cond int 1 regular  }
	{ colorFormat_val_cast int 3 regular  }
	...
	{ axi_data_3_out int 48 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "sof_2", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "axi_data_2", "interface" : "wire", "bitwidth" : 48, "direction" : "READONLY"} , 
 	{ "Name" : "trunc_ln", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
 	{ "Name" : "cond", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "colorFormat_val_cast", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "axi_data_3_out", "interface" : "wire", "bitwidth" : 48, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ axi_data_2 sc_in sc_lv 48 signal 2 } 
	{ trunc_ln sc_in sc_lv 11 signal 3 } 
	{ cond sc_in sc_lv 1 signal 4 } 
	{ colorFormat_val_cast sc_in sc_lv 3 signal 5 } 
	{ colorFormat_val sc_in sc_lv 3 signal 6 } 
	...
	{ axi_data_3_out sc_out sc_lv 48 signal 16 } 
	{ axi_data_3_out_ap_vld sc_out sc_logic 1 outvld 16 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "axi_data_2", "direction": "in", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "axi_data_2", "role": "default" }} , 
 	...
 	{ "name": "colorFormat_val_cast", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "colorFormat_val_cast", "role": "default" }} , 
 	...
 	{ "name": "axi_data_3_out", "direction": "out", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "axi_data_3_out", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_5_8_8_1_1_U15", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	axi_data_2 { ap_none {  { axi_data_2 in_data 0 48 } } }
	trunc_ln { ap_none {  { trunc_ln in_data 0 11 } } }
	cond { ap_none {  { cond in_data 0 1 } } }
	colorFormat_val_cast { ap_none {  { colorFormat_val_cast in_data 0 3 } } }
	...
	axi_data_3_out { ap_vld {  { axi_data_3_out out_data 1 48 }  { axi_data_3_out_ap_vld out_vld 1 1 } } }
}
