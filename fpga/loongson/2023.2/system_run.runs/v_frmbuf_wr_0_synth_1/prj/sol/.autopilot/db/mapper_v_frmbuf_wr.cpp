...
extern "C" void v_frmbuf_wr(Byte<16>*, short, short, short, short, int, int, int, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);
...
auto* ss_axis_video_V_dest_V = createStream((hls::stream<char>*)__xlx_apatb_param_s_axis_video_V_dest_V);
  // DUT call
  v_frmbuf_wr(__xlx_frm_buffer_frm_buffer2_frm_buffer3__tmp_vec.data(), __xlx_apatb_param_width, __xlx_apatb_param_height, __xlx_apatb_param_stride, __xlx_apatb_param_video_format, __xlx_offset_byte_param_frm_buffer, __xlx_offset_byte_param_frm_buffer2, __xlx_offset_byte_param_frm_buffer3, ss_axis_video_V_data_V->data<long long>(), ss_axis_video_V_keep_V->data<char>(), ss_axis_video_V_strb_V->data<char>(), ss_axis_video_V_user_V->data<char>(), ss_axis_video_V_last_V->data<char>(), ss_axis_video_V_id_V->data<char>(), ss_axis_video_V_dest_V->data<char>());
