...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler v_frmbuf_wr_0_sparsemux_5_8_8_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {auto}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_img \
    op interface \
    ports { img_din { O 48 vector } img_num_data_valid { I 3 vector } img_fifo_cap { I 3 vector } img_full_n { I 1 bit } img_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { axi_data_3_out { O 48 vector } axi_data_3_out_ap_vld { O 1 bit } } \
} "
}
