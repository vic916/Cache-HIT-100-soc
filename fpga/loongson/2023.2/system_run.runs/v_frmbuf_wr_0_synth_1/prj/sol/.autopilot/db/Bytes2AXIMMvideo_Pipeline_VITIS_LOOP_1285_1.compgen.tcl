...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln1285 \
    op interface \
    ports { sext_ln1285 { I 28 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { bytePlanes_dout { I 128 vector } bytePlanes_num_data_valid { I 10 vector } bytePlanes_fifo_cap { I 10 vector } bytePlanes_empty_n { I 1 bit } bytePlanes_read { O 1 bit } } \
} "
}
