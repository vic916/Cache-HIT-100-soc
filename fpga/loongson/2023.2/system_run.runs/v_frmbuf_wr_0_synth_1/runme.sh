...
HD_PWD='C:/Users/XF/Desktop/chiplabdemo/chiplab/fpga/loongson/2023.2/system_run.runs/v_frmbuf_wr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log v_frmbuf_wr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source v_frmbuf_wr_0.tcl
