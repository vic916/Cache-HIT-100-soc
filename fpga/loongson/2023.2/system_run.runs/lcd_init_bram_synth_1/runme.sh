...
HD_PWD='C:/Users/XF/Desktop/chiplabdemo/chiplab/fpga/loongson/2023.2/system_run.runs/lcd_init_bram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lcd_init_bram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lcd_init_bram.tcl
